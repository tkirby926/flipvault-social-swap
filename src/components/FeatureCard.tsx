...
const FeatureCard = ({ Icon, title, description }: FeatureCardProps) => (
  <div className="flex flex-col items-center p-6 bg-white rounded-xl shadow-lg border-4 border-primary/30 hover:border-primary/70 transition hover:scale-110 hover:shadow-2xl duration-300 animate-pop-in h-full">
